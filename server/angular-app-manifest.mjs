...
export default {
  ...
  assets: {
    ...
    'signup/index.html': {size: 165777, hash: '2162e948b9738f959fd0cd48acdecd554c2e80ac38fee3f6dfa5d77d1a3b2123', text: () => import('./assets-chunks/signup_index_html.mjs').then(m => m.default)},

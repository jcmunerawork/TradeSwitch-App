...
@Component({
  selector: 'app-edit-risk-reward-ratio',
  templateUrl: './edit-risk-reward.component.html',
  styleUrls: ['./edit-risk-reward.component.scss'],
  imports: [CommonModule],
  standalone: true,
})
export class EditRiskRewardComponent implements OnInit {

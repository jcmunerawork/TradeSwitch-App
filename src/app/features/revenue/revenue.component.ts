...
export class RevenueComponent {
  ...
  getHistoricalData() {
    ...
    // Llamada al endpoint real para ver qué datos trae
    this.reportService.getHistoricalData(
      routeId,
      from,
      to,
      resolution,
      ...
      next: (response) => {
        console.log('Respuesta del endpoint /history:', response);
        // Aquí puedes ver la estructura de datos que te trae el endpoint
        // y decidir cómo mapear los datos reales a tu interfaz OrderTableRow
      },
      error: (error) => {
